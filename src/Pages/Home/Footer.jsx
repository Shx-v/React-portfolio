  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/logo.svg" width={150} alt="Logoipsum" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/shivranjan.bharadwaj.9/?paipv=0&eav=AfYfgspNderQH_g9SzVANgGtcooRlnCSlSjxHFjKhLYxoEDv7M1Z9DI-7s78PqFgQ2g&_rdr"
            ...
            <li>
              <a
                href="https://instagram.com/_.lu_c_k_y.__?igshid=MzRlODBiNWFlZA=="
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://x.com/Shiv_bharadwaj_?t=hRXZ0EYKlO1Hp1FnFx_kRw&s=08"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Shivranjan</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
